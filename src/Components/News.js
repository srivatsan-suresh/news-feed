...
export class News extends Component {
    ...
    async componentDidMount() {
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=b2c2840d8ec24c9192df7cec0ad8f5b6&pageSize=${this.props.pageSize}`;
    ...
    prevPg = async () => {
        ...
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=b2c2840d8ec24c9192df7cec0ad8f5b6&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
